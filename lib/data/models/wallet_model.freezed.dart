...
class _$WalletImpl extends _Wallet {
  const _$WalletImpl(
      ...
      @HiveField(2) required this.balance,
      @HiveField(3) this.isDeleted = false,
  ...
  @override
  String toString() {
    return 'Wallet(id: $id, name: $name, balance: $balance, isDeleted: $isDeleted, updatedAt: $updatedAt)';
  }
...
abstract class _Wallet extends Wallet {
  const factory _Wallet(
      ...
      @HiveField(2) required final double balance,
      @HiveField(3) final bool isDeleted,
      @HiveField(4) required final DateTime updatedAt}) = _$WalletImpl;
