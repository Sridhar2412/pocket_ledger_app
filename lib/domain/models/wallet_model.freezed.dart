...
class _$WalletModelImpl implements _WalletModel {
  ...
  @override
  String toString() {
    return 'WalletModel(id: $id, name: $name, balance: $balance, isDeleted: $isDeleted, updatedAt: $updatedAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, balance, isDeleted, updatedAt);
...
abstract class _WalletModel implements WalletModel {
  const factory _WalletModel(
      ...
      final bool isDeleted,
      required final DateTime updatedAt}) = _$WalletModelImpl;
